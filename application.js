...
function renderStoreDetails(container, template, collection, slug){
    ...
    $.each( item_list , function( key, val ) {
        if ((val.store_front_url).indexOf('missing.png') > -1){
            val.alt_store_front_url = "http://assets.codecloudapp.com/sites/5787a4446e6f642686010000/image/png/undefined/corelogo.png";
        } else {
            val.alt_store_front_url = getImageURL(val.store_front_url); 
        }
...
function renderPromoDetails(container, template, collection, centre){
    ...
    $.each( item_list , function( key, val ) {
        ...
        if (val.promotionable_type == "Store") {
            ...
            val.store_name = mall_name;
            val.store_image = "http://assets.codecloudapp.com/sites/5787a4446e6f642686010000/image/png/1461163897000/Logo.png";
            val.store_show = "display:none";
            val.phone_show = "display:none";
        }
        val.image_url = val.promo_image_url_abs
...
function renderEventDetails(container, template, collection, mall_name){
    ...
    $.each( item_list , function( key, val ) {
        if (val.eventable_type == "Store") {
            ...
            val.store_name = mall_name;
            val.store_image = "http://assets.codecloudapp.com/sites/5787a4446e6f642686010000/image/png/undefined/corelogo.png";
            val.store_show = "display:none";
            val.phone_show = "display:none";
            val.show = "display:none";
        }
...
function renderPosts(container, template, collection){
    ...
    $.each( collection , function( key, val ) {
        if (val.image_url.indexOf('missing.png') > -1) {
            val.post_image = "http://assets.codecloudapp.com/sites/5787a4446e6f642686010000/image/png/undefined/corelogo.pngg";
        } else {
...
function renderPostDetails(container, template, collection){
    ...
    $.each( collection , function( key, val ) {
        if (val.image_url.indexOf('missing.png') > -1) {
            val.post_image = "http://assets.codecloudapp.com/sites/5787a4446e6f642686010000/image/png/undefined/corelogo.png";
        } else {
            val.post_image = val.image_url;
        }
        if(val.body.length > 100){
